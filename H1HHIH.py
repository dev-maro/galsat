...
ownerID = int("956893993") #ايدي الادمن 
api_hash = "d5031334164f12ef47a7f3c7c3116207" #ايبي هاش 
api_id = 21769847 #ايبي ايدي
token = "6813976244:AAHOAOX_mKv3PY88gjleMnilluuJoUpnR7c" #توكن البوت


bot = Client(
  'bot'+token.split(":")[0],
  21769847, #ايبي ايدي
 'd5031334164f12ef47a7f3c7c3116207', #ايبي هاش
...
async def generator_and_about(app,m):
    if m.text == "مـعـلـومـات عـن الـبـوت":
      ...
      text += f"\n\n👤 مـطـور الـبـوت: @vip_alpop @j_s_9"
...
app.start()
bot.start()
print("تم تشغيل البوت @vip_alpop @j_s_9")
idle()